...
<head>
<title>Startup SEO   Package - The Webeez</title>
...
<div class="container">
   <div class="col-md-12">
        <h2 class="myheading">Startup SEO   Package</h2>
  ...
  <div class="row">
    <div class="col-lg-4 col-md-4 col-sm-4">
      <div class="subs-pac bronze ">
          ...
          <h6><span class="old">$898.00</span>    $449.00   <!-- <b>USD</b> --> <span><b class="monthss"></b>Suitable for potential super-startups and brand revamps for companies.</span></h6>
          ...
          <div class="table-packages bronze">
            ...
            <div class="body">
              <ul class="subscription-list">
                ...
                <li>
                  <h6>Informational Content Writing & Sharing (2 - Per Month)</h6>
                  <span class="tick"></span>
                </li>
                <li>
                  <h6>Blog Writing (1 - Per Month)</h6>
                  <span class="tick"></span>
                </li>
                <li>
                  <h6>Press Release Social Bookmarking (5 - Per Month)</h6>
                  <span class="tick"></span>
                </li>
                <li>
                  <h6>NAP Syndication</h6>
                  <span class="tick"></span>
                </li>
                <li>
                  <h6>Google My Business / Bing Local Listing</h6>
                  <span class="tick"></span>
                </li>
                <li>
                  <h6>Citation Building</h6>
                  <span class="tick"></span>
                </li>
                <li>
                  <h6>Classified Submissions</h6>
                  <span class="tick"></span>
                </li>
                <li>
                  <h6> Google Analytics Analysis Report</h6>
                  <span class="tick"></span>
                </li>
                <li>
                  <h6>SEO Reports</h6>
                ...
                <li>
                  <h6>Search Engine Rank Report</h6>
                  <span class="tick"></span>
                </li>
                <li>

...
<head>
<title>Unlimited Collateral Packages - The Webeez</title>
  ...
  <div class="row">
    <div class="col-lg-4 col-md-4 col-sm-4">
      <div class="subs-pac bronze ">
          ...
          <h6><span class="old">$499.98</span>     $249.99    <!-- <b>USD</b> --> <span><b class="monthss"></b>Suitable for potential super-startups and brand revamps for companies.</span></h6>
          ...
          <div class="table-packages bronze">
            ...
            <div class="body">
              <ul class="subscription-list">
                <li>
                  <h6>2 Stationery Design Set</h6>
                  <span class="tick"></span>
                </li>
                <li>
                  <h6>Menu Card Design</h6>
                  <span class="tick"></span>
                </li>

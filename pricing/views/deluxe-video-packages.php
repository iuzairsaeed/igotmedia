...
<head>
<title>Deluxe Video  Package- The Webeez</title>
...
<div class="container">
   <div class="col-md-12">
        <h2 class="myheading">Deluxe Video  Packages</h2>
  ...
  <div class="row">
    <div class="col-lg-4 col-md-4 col-sm-4">
      <div class="subs-pac bronze ">
          ...
          <h6><span class="old">$1,798.00</span>     $899.00    <!-- <b>USD</b> --> <span><b class="monthss"></b>Suitable for potential super-startups and brand revamps for companies.</span></h6>
          ...
          <div class="table-packages bronze">
            ...
            <div class="body">
              <ul class="subscription-list">
                <li>
                  <h6>120 Second Video - HD 1080</h6>

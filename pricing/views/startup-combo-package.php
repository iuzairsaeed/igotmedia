...
<head>
<title>Startup Combo Package - The Webeez</title>
  ...
  <div class="row">
    <div class="col-lg-4 col-md-4 col-sm-4">
      <div class="subs-pac bronze ">
          ...
          <h6><span class="old">$1,399.98.00</span>   $999.99   <!-- <b>USD</b> --> <span><b class="monthss"></b>Suitable for potential super-startups and brand revamps for companies.</span></h6>
          ...
          <div class="table-packages bronze">
            ...
            <div class="body">
              <ul class="subscription-list">
                <li><h6>Unlimited Logo Design Concepts</h6><span class="tick"></span></li>
                <li><h6>+ Social Media Design</h6><span class="tick"></span></li>
                <li><h6>Mobile Responsive</h6><span class="tick"></span></li>
                <li><h6>3 Dedicated Designers</h6><span class="tick"></span></li>
                <li><h6>Icon Design</h6><span class="tick"></span></li>
                <li><h6>Business Card, Letterhead, Envelope</h6><span class="tick"></span></li>
                ...
                <li><h6>5 Stock Photos + 3 Banner Designs</h6><span class="tick"></span></li>

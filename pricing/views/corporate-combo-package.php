...
<head>
<title>Corporate Combo Package - The Webeez</title>
  ...
  <div class="row">
    <div class="col-lg-4 col-md-4 col-sm-4">
      <div class="subs-pac bronze ">
          ...
          <h6><span class="old">$2,999.98</span>   $1999.99  <!-- <b>USD</b> --> <span><b class="monthss"></b>Suitable for potential super-startups and brand revamps for companies.</span></h6>
          ...
          <div class="table-packages bronze">
            ...
            <div class="body">
              <ul class="subscription-list">
                ...
                <li><h6>8 Dedicated Designers</h6><span class="tick"></span></li>
                <li><h6>Icon Design</h6><span class="tick"></span></li>
                <li><h6>2 Free Custom Stationary Designs</h6><span class="tick"></span></li>
                <li><h6>MS Word Letterhead</h6><span class="tick"></span></li>
                <li><h6>Invoice Design</h6><span class="tick"></span></li>
                <li><h6>Product Catalog Design</h6><span class="tick"></span></li>
                ...
                <li><h6>Facebook Page Design</h6><span class="tick"></span></li>
                <li><h6>Twitter Page Design</h6><span class="tick"></span></li>
                <li><h6>YouTube Page Design</h6><span class="tick"></span></li>
                <li><h6>Google+ Page Design</h6><span class="tick"></span></li>
                <li><h6>Pinterest Page Design</h6><span class="tick"></span></li>

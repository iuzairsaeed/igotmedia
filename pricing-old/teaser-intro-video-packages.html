...
<head>
<title>Teaser/Intro Video  Package- The Webeez</title>
...
<div class="container">
   <div class="col-md-12">
        <h2 class="myheading">Teaser/Intro Video Packages</h2>
  ...
  <div class="row">
    <div class="col-lg-4 col-md-4 col-sm-4">
      <div class="subs-pac bronze ">
          ...
          <h6><span class="old">$298.00</span>     $149.00     <!-- <b>USD</b> --> <span><b class="monthss"></b>Suitable for potential super-startups and brand revamps for companies.</span></h6>
          
        <a href="../order9187.html?pack=15" class="ordrrrr">Place Your Order</a>
          ...
          <div class="table-packages bronze">
            ...
            <div class="body">
              <ul class="subscription-list">
                ...
                <li>
                  <h6>Custom Setting, Characters & Graphics</h6>
                  <span class="tick"></span>
                </li>
                ...
                <li>
                 ...
                 <li>
                  <h6>Voice - Over & Sound Effects (All accents) (M/F)</h6>
                  <span class="tick"></span>
                </li>
                 <li>

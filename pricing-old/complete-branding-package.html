...
<head>
<title>Complete Branding Solution  - The Webeez</title>
  ...
  <div class="row">
    <div class="col-lg-4 col-md-4 col-sm-4">
      <div class="subs-pac bronze ">
          <h3>Complete Branding  <br> Package</h3>
          <h6><span class="old">$1,989.00</span>    $994.99    <!-- <b>USD</b> --> <span><b class="monthss"></b>Suitable for potential super-startups and brand revamps for companies.</span></h6>
          ...
          <div class="table-packages bronze">
            ...
            <div class="body">
              <ul class="subscription-list">
                <li><h6>Unlimited Custom Logo Design Concepts</h6><span class="tick"></span></li>
                <li><h6>6 Dedicated Designers</h6><span class="tick"></span></li>

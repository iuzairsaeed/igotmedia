...
<head>
<title>AutomatedInteractive Conferencing Portal   - The Webeez</title>
...
<div class="container">
   <div class="col-md-12">
        <h2 class="myheading">AutomatedInteractive Conferencing Portal</h2>
  ...
  <div class="row">
    <div class="col-lg-4 col-md-4 col-sm-4">
      <div class="subs-pac bronze ">
          <h3>AutomatedInteractive Conferencing Portal <br> Package</h3>
          <h6><span class="old">$9,999.98</span>   $4,999.99  <!-- <b>USD</b> --> <span><b class="monthss"></b>Suitable for potential Mid Sized and Enterprise companies.</span></h6>
